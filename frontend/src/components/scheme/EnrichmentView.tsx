                                    ...
                                    <tbody className="divide-y divide-slate-100 dark:divide-white/5">
                                        {sortedPeers.map((peer: any, i: number) => {
                                            ...
                                            return (
                                                <tr
                                                    key={i}
                                                    className={`hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all ${isHighlight ? 'bg-indigo-100/50 dark:bg-indigo-500/20 shadow-[inset_4px_0_0_0_theme(colors.indigo.500)]' : ''} ${isClickable ? 'cursor-pointer' : ''}`}
